...
public abstract class CondensePinkWater extends BaseColorWater {
    ...
    public net.minecraft.fluid.Fluid getStill() {
        return ModFluids.STILL_CONDENSE_PINK_WATER;
    }

    @Override
    public net.minecraft.fluid.Fluid getFlowing() {
        return ModFluids.FLOWING_CONDENSE_PINK_WATER;
    }

    @Override
    public Item getBucketItem() {
        return ModItems.CONDENSE_PINK_WATER_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState fluidState) {
        // getBlockStateLevel converts the LEVEL_1_8 of the fluid state to the LEVEL_15 the fluid block uses
        return ModBlocks.CONDENSE_PINK_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
    }
    ...
    public static class Still extends CondensePinkWater {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
