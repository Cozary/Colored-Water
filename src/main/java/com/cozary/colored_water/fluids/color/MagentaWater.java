...
public abstract class MagentaWater extends BaseColorWater {
    ...
    protected BlockState toBlockState(FluidState fluidState) {
        ...
        return ModBlocks.MAGENTA_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
    }
    ...
    public static class Still extends MagentaWater {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
