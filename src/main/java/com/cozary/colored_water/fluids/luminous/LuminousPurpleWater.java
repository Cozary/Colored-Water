...
public abstract class LuminousPurpleWater extends BaseColorWater {
    ...
    public net.minecraft.fluid.Fluid getStill() {
        return ModFluids.STILL_LUMINOUS_PURPLE_WATER;
    }

    @Override
    public net.minecraft.fluid.Fluid getFlowing() {
        return ModFluids.FLOWING_LUMINOUS_PURPLE_WATER;
    }

    @Override
    public Item getBucketItem() {
        return ModItems.LUMINOUS_PURPLE_WATER_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState fluidState) {
        // getBlockStateLevel converts the LEVEL_1_8 of the fluid state to the LEVEL_15 the fluid block uses
        return ModBlocks.LUMINOUS_PURPLE_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
    }
    ...
    public static class Still extends LuminousPurpleWater {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
