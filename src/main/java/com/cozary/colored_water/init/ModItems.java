...
public class ModItems {
    ...
    public static final DeferredItem<Item> LUMINOUS_WHITE_WATER_BUCKET = registerWithSet("luminous_white_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_WHITE_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_WHITE_WATER_BUCKET = registerWithSet("luminous_condense_white_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_WHITE_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_ORANGE_WATER_BUCKET = registerWithSet("luminous_orange_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_ORANGE_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_ORANGE_WATER_BUCKET = registerWithSet("luminous_condense_orange_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_ORANGE_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_MAGENTA_WATER_BUCKET = registerWithSet("luminous_magenta_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_MAGENTA_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_MAGENTA_WATER_BUCKET = registerWithSet("luminous_condense_magenta_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_MAGENTA_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_LIGHT_BLUE_WATER_BUCKET = registerWithSet("luminous_light_blue_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_LIGHT_BLUE_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_LIGHT_BLUE_WATER_BUCKET = registerWithSet("luminous_condense_light_blue_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_LIGHT_BLUE_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_YELLOW_WATER_BUCKET = registerWithSet("luminous_yellow_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_YELLOW_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_YELLOW_WATER_BUCKET = registerWithSet("luminous_condense_yellow_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_YELLOW_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_LIME_WATER_BUCKET = registerWithSet("luminous_lime_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_LIME_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_LIME_WATER_BUCKET = registerWithSet("luminous_condense_lime_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_LIME_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_PINK_WATER_BUCKET = registerWithSet("luminous_pink_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_PINK_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_PINK_WATER_BUCKET = registerWithSet("luminous_condense_pink_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_PINK_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_GRAY_WATER_BUCKET = registerWithSet("luminous_gray_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_GRAY_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_GRAY_WATER_BUCKET = registerWithSet("luminous_condense_gray_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_GRAY_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_LIGHT_GRAY_WATER_BUCKET = registerWithSet("luminous_light_gray_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_LIGHT_GRAY_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_LIGHT_GRAY_WATER_BUCKET = registerWithSet("luminous_condense_light_gray_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_LIGHT_GRAY_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_CYAN_WATER_BUCKET = registerWithSet("luminous_cyan_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CYAN_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_CYAN_WATER_BUCKET = registerWithSet("luminous_condense_cyan_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_CYAN_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_PURPLE_WATER_BUCKET = registerWithSet("luminous_purple_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_PURPLE_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_PURPLE_WATER_BUCKET = registerWithSet("luminous_condense_purple_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_PURPLE_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_BLUE_WATER_BUCKET = registerWithSet("luminous_blue_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_BLUE_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_BLUE_WATER_BUCKET = registerWithSet("luminous_condense_blue_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_BLUE_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_BROWN_WATER_BUCKET = registerWithSet("luminous_brown_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_BROWN_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_BROWN_WATER_BUCKET = registerWithSet("luminous_condense_brown_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_BROWN_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_GREEN_WATER_BUCKET = registerWithSet("luminous_green_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_GREEN_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_GREEN_WATER_BUCKET = registerWithSet("luminous_condense_green_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_GREEN_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_RED_WATER_BUCKET = registerWithSet("luminous_red_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_RED_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_RED_WATER_BUCKET = registerWithSet("luminous_condense_red_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_RED_WATER.get()));
    ...
    public static final DeferredItem<Item> LUMINOUS_BLACK_WATER_BUCKET = registerWithSet("luminous_black_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_BLACK_WATER.get()));
    public static final DeferredItem<Item> LUMINOUS_CONDENSE_BLACK_WATER_BUCKET = registerWithSet("luminous_condense_black_water_bucket", () -> new FoilBucketItem(STILL_LUMINOUS_CONDENSE_BLACK_WATER.get()));
