...
public class ModItems {
    ...
    public static final Supplier<Item> COLORED_WATER_BUCKET = registerWithSet("colored_water_bucket",
    ...
    private static Supplier<Item> registerWithSet(String name, Supplier<Item> supplier) {
